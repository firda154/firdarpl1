                    ...
                    <?php foreach ($role as $r) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('admin/hapusrole/') . $r['id'] ?>" onclick="return confirm('apakah anda yakin')"
...
<div class="modal fade" id="editrole<?= $r['id'] ?>" tabindex="-1" aria-labelledby="editrole" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id=editroleLabel>Add New Role</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
