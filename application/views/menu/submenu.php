                ...
                <tbody>
                    ...
                    <?php foreach ($SubMenu as $sm) : ?>
                        <tr>
                            ...
                            <td><?= $sm['is_active']; ?></td>
                            <td>
                                <a href="menu/title" class="badge badge-success" data-toggle="modal" data-target="#exampleModalsubedit<?= $sm['id']; ?>">Edit</a>
                                <a href="<?= base_url('menu/delete/'); ?><?= $sm['id']; ?>" class="badge badge-danger" onclick="return confirm('yakin akan dihapus ?');">Delete</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
